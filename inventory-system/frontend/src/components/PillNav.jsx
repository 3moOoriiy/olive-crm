  ...
  return (
    <div className="pill-nav-container">
      <nav className={`pill-nav ${className}`} aria-label="Primary" style={cssVars}>
        ...
        <div className="pill-nav-items pn-desktop-only" ref={navItemsRef}>
        ...
        <button className="mobile-menu-button pn-mobile-only" onClick={toggleMobileMenu}
      ...
      <div className="mobile-menu-popover pn-mobile-only" ref={mobileMenuRef} style={cssVars}>
